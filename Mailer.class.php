...
class Mailer {
	public function send($user) {
		...
		$mail->Mailer = "mail";
		$mail->Host = 'mail.editorialpaginas.com.ar';  // Specify main and backup SMTP servers
		// $mail->Port = 25; //587
		$mail->SMTPAuth = true;                               // Enable SMTP authentication
		$mail->Username = 'info@editorialpaginas.com.ar';                 // SMTP username
		$mail->Password = 'R1v3rpl4t3';                           // SMTP password
